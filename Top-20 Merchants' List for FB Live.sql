/*
- Viz: 
- Data: https://docs.google.com/spreadsheets/d/1lLAva_M3ZMK_9xVXLFqwfMztesp3KfrydWGhmWux2Hc/edit#gid=544935822
- Function: 
- Table:
- Instructions: 
- Format: 
...
- Email thread: Re: Top 20 Users List of Tallykhata
- Notes (if any): 
*/
...
from 
	...
	from 
		...
		where 
			district_name in('Narayanganj', 'Gazipur')
			and upazilla_name ilike '%sadar%'
				/*(data_vajapora.lat_long_dist_meters(23.6238, 90.5000, lat::numeric, lng::numeric)<=4000 -- Narayanganj
				or 
				data_vajapora.lat_long_dist_meters(23.9999, 90.4203, lat::numeric, lng::numeric)<=4000 -- Gazipur
				)*/
		) tbl1 
		inner join 

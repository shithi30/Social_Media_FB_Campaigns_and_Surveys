/*
- Viz: 
- Data: https://docs.google.com/spreadsheets/d/1lLAva_M3ZMK_9xVXLFqwfMztesp3KfrydWGhmWux2Hc/edit#gid=1930066713
- Function: 
- Table:
- Instructions: 
- Format: 
...
from 
	(select 
		*, 
		case 
			when district_name='Sirajganj' then data_vajapora.lat_long_dist_meters(24.4526, 89.6816, lat::numeric, lng::numeric) 
			when district_name='Tangail' then data_vajapora.lat_long_dist_meters(24.2513, 89.9167, lat::numeric, lng::numeric) 
		end distance, 
	...
	from 
		...
		where 
			district_name in('Sirajganj', 'Tangail')
			...
			and 
				(data_vajapora.lat_long_dist_meters(24.4526, 89.6816, lat::numeric, lng::numeric)<=4300 -- Sirajganj
				or 
				data_vajapora.lat_long_dist_meters(24.2513, 89.9167, lat::numeric, lng::numeric)<=4800 -- Tangail
				)			
		) tbl1 
		inner join 
